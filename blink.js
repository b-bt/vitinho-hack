...
// MARK: Capacitive touch sensor
var capaciSensor = new Gpio(16, 'in', 'both', {debounceTimeout: 10}); //use GPIO pin 16 as input, and 'both' button presses, and releases should be handled
capaciSensor.watch(function (err, value) { //Watch for hardware interrupts on pushButton GPIO, specify callback function
  if (err) { //if an error
    console.error('There was an error', err); //output error message to console
    return;
  }
